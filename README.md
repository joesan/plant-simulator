...
![Contributors](https://img.shields.io/github/contributors/joesan/plant-simulator.svg)
...
UPDATE: Heroku stopped giving away free to run nodes, so the version that I have been running on Heroku does not work anymore. I'm trying to find out an alternative sooner!
